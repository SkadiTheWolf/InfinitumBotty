...
jokes = [
    ...
    ["Was ist orange und schaut durchs Schlüsselloch?", "Eine Spanndarine."],
    ["Was ist violett und sitzt in der Kirche ganz vorne?", "Eine Frommbeere."],
    ["Was ist grün und liegt im Sarg?", "Ein Sterbschen."],
    ...
    ["Was ist grün und kommt aus Istanbul?", "Ein Gürke"],
    [
        "Was ist hellbraun und hangelt sich von Tortenstück zu Tortenstück?",
        "Ein Tarzipan.",
    ],
    ["Was ist braun und klebt an der Wand?", "Ein Klebkuchen"],
    ["Was ist gelb und rutscht den Hang hinunter?", "Ein Cremeschlitten."],
    ["Was ist weiß und tanzt ums Feuer?", "Rumpelpilzchen."],
    ...
    ["Was hüpft über die Wiese und raucht?", "Ein Kaminchen."],
    ["Was ist knusprig und liegt unterm Baum?", "Ein Schattenplätzle."],
    ["Kleines Schwein das nach Hilfe schreit?", "Ein Notrufsäule."],
    ["Was liegt am Strand und hat Schnupfen?", "Eine Niesmuschel."],
    ["Was ist ein Cowboy ohne Pferd?", "Ein Sattelschlepper."],
    ["Was ist schwarz-weiß und kommt nicht vom Fleck?", "Ein Klebra."],
    ["Was ist rosa, quiekt und wird zum Hausbau verwendet?", "Ein Ziegelschwein."],
    ["Wer ist bei jeder Wanderung betrunken?", "Der Schlucksack."],
    ["Was ist rot und wiehert?", "Die Pferdbeer.e"],
    ["Was ist weiß, blau, grün und steht auf der Wiese?", "Eine Schlumpfdotterblume."],
    ["Was kaut und hat immer Verspätung?", "Die Essbahn."],
    ...
    ["Was lebt im Meer und kann gut rechnen?", "Der Octoplus."],
    ["Was ist tiefergelegt und schwimmt unter wasser?", "Der Tunefisch."],
    ["Was ist unter der Erde und stinkt?", "Eine Furzel."],
    ["Von was wird man nachts beobachtet?", "Vom Spannbettlaken."],
    ["Wo wohnen die meisten Katzen?", "Im Miezhaus."],
    ["Warum ging der Luftballon kaputt?", "Aus Platzgründen."],
    ["Wie nennt man einen ausgehungerten Frosch?", "Magerquak."],
    ...
    ["Was sitzt in der Savanne und wäscht sich?", "Die Hygiäne."],
    ["Was sitzt im Dschungel und spielt unfair?", "Mogli."],
    ["Wie nennt man den Paarungsruf von Leutstofflampen?", "Neonröhren."],
]
...
class JokeObserver(PrivMsgObserverPrototype):
    ...
    def update_on_priv_msg(self, data: dict, connection: Connection):
        if data["message"].startswith(".joke"):
